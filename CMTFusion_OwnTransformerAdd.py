...
class CMTFusion(nn.Module):
    def __init__(self):
        ...
        self.Stage1_1_own_tf_rgb = Own_TF()
        self.Stage1_1_own_tf_ir = Own_TF()
        self.Stage2_1_own_tf_rgb = Own_TF()
        self.Stage2_1_own_tf_ir = Own_TF()
        self.Stage3_1_own_tf_rgb = Own_TF()
        self.Stage3_1_own_tf_ir = Own_TF()
    ...
    def forward(self, rgb, ir):
        ...
        #### RFDB이후, Own Transformer 적용 #####
        ir_level_3 = self.ir_encoder_level3(ir_level_3) # RFDB
        ir_level_3 = self.Stage3_1_own_tf_ir(ir_level_3) # Own TF(RGB) 
        rgb_level_3 = self.rgb_encoder_level3(rgb_level_3) # RFDB 
        rgb_level_3 = self.Stage3_1_own_tf_rgb(rgb_level_3) # Own TF(IR) 
        
        ir_level_2 = self.ir_encoder_level2(ir_level_2) # RFDB
        ir_level_2 = self.Stage2_1_own_tf_ir(ir_level_2)
        rgb_level_2 = self.rgb_encoder_level2(rgb_level_2) # RFDB 
        rgb_level_2 = self.Stage2_1_own_tf_rgb(rgb_level_2)

        ir_level_1 = self.ir_encoder_level1(ir_level_1) # RFDB
        ir_level_1 = self.Stage1_1_own_tf_ir(ir_level_1)
        rgb_level_1 = self.rgb_encoder_level1(rgb_level_1) # RFDB
        rgb_level_1 = self.Stage1_1_own_tf_rgb(rgb_level_1)
        ##################################################Level3
...
def main():
    model = CMTFusion()
    summary(model, input_size=[(1, 1, 275, 575), (1, 1, 275, 575)])
